...
def is_ucschar(c: str) -> bool:
    ...
    assert len(c) == 1
    return ord(c) in range(0xA0, 0xD7FF + 1) or ord(c) in range(0xF900, 0xFDCF + 1) or ord(c) in range(0xFDF0, 0xFFEF + 1) or ord(c) in range(0x10000, 0x1FFFD + 1) or ord(c) in range(0x20000, 0x2FFFD + 1) or ord(c) in range(0x30000, 0x3FFFD + 1) or ord(c) in range(0x40000, 0x4FFFD + 1) or ord(c) in range(0x50000, 0x5FFFD + 1) or ord(c) in range(0x60000, 0x6FFFD + 1) or ord(c) in range(0x70000, 0x7FFFD + 1) or ord(c) in range(0x80000, 0x8FFFD + 1) or ord(c) in range(0x90000, 0x9FFFD + 1) or ord(c) in range(0xA0000, 0xAFFFD + 1) or ord(c) in range(0xB0000, 0xBFFFD + 1) or ord(c) in range(0xC0000, 0xCFFFD + 1) or ord(c) in range(0xD0000, 0xDFFFD + 1) or ord(c) in range(0xE1000, 0xEFFFD + 1)
...
def is_pct_encoded(s: str) -> bool:
    ...
    return len(s) == 3 and s[0] == '%' and s[1] in '01234567890abcdefABCDEF' and s[2] in '01234567890abcdefABCDEF'
...
def is_url_code_point(c: str) -> bool:
    ...
    assert len(c) == 1
    return (c.isascii() and c.isalnum()) or c in "!$&'()*+,-./:'=?@_~" or (ord(c) in range(0x00A0, 0x10FFFD + 1) and not is_surrogate(c) and not is_noncharacter(c))
